...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    highlightedInProjects: ["paypilotai", "physioconnect"],
  ...
  },
  {
    name: "Python",
    category: "Languages",
    focus: "Machine learning, FastAPI, LightGBM, Graph network models",
    usageContext: "Building ML microservices, automated fraud risk scoring inference, and backend data transformation pipelines.",
    highlightedInProjects: ["paypilotai"],
    level: "Production Ready",
    iconSlug: "python",
  },
  {
